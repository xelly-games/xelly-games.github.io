...
Okay, so you've got your core project set up.
...
Before we dig in and explain things here, let's build and run our "game"
(it's just a Hello World! message for now):
...
:::note
**Nothing is actually uploaded** to any remote servers by this tool. The tool uses
`FileReader.readAsText` (see [docs](https://developer.mozilla.org/en-US/docs/Web/API/FileReader/readAsText))
to read the file _locally_ on your computer and render it for you to test it.
:::

You should see something like this, which is your game running as it would in
a xelly.games feed:

<p style={{textAlign: "center", border: "1px solid #ccc"}}>
![Hello World](./img/ss-hello-world.png)
</p>
