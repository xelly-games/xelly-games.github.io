...
It will be common to want to update and/or fix your game after it's been submitted
and approved &mdash; i.e., to fix bugs, add some nice animations or transitions,
improve the user experience, or just make the game a little bit better.

Of course you could just delete your game and submit a new version but then
your users will lose all the bookmarks, likes, and plays of your game.

Here's how you do an "in-place" update to your game:
...
* You should only update your game if you have made moderate changes to it &mdash;
    ...
    may not be approved if the changes are too drastic.
