...
resources such as more code, images, sprites, or fonts.

:::tip
By the way! [Kenney](https://kenney.nl/) is a great place for finding
free assets (sprites, etc) for your games.
:::
...
To bundle an image resource into your game, you have
a couple of options:
