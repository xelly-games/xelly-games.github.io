...
xelly.games [**"utility" page**](https://xelly.games/utility).
...
:::tip
**Nothing is actually uploaded** to any remote servers by this utility page.

The page uses
[`FileReader.readAsText`](https://developer.mozilla.org/en-US/docs/Web/API/FileReader/readAsText)
to read the file _locally_ on your computer and render it so you to test it.
:::
