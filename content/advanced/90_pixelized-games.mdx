...
[**@jules**](https://xelly.games/profile/jules) on **[xelly.games](https://xelly.games)** likes to make games
...
<div style={{display: 'flex', gap: '10px', flexWrap: 'wrap', margin: '25px'}}>
    <EmbeddedGame
        width={412}
...
[`@xelly/xelly.js` SDK](https://github.com/xelly-games/xelly.js)!
