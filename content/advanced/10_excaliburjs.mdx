...
The [ExcaliburJS docs](https://excaliburjs.com/docs/) are fantastic and 
...
acceleration), collision detection, and input/output.
...
rendering and moving on the screen, but typically we will want to set the Actor's
...
Now you might say we have a game! Click on the purple ball before it leaves the
screen forever! 😱
