...
you would lose all of the bookmarks, likes, and plays of your game from all the
users that have engaged with it.

This page explains how to do an "in-place" update to your game.

:::note
You should only update your game if you've made moderate changes to it &mdash;
for example, bug fixes, usability enhancements and fixes, etc.

If your new
version is substantially different, you should submit a new game. Your update
may not be approved if the changes to the game are too substantial from the
original.
:::
...
2. Upload the new version of your game. (For updates, you are not able to
change the [aspect ratio](./device-dimensions#aspect-ratio) or
