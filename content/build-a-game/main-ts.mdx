...
Here, we indicate that the `type` of our game is a **"passive"** game, i.e., it's
not an interactive game. Since this was our "Hello World" example, there's
...
However, you should read through
[Advanced Topics](../category/advanced-topics)
before you publish your first game.
